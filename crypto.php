...
<head>
				...
				<title>Criptografia - Cyber Root</title><link rel="stylesheet" href="https://bootstrapstudio.io/demo//embed//bootstrap/4/default/bootstrap.min.css">
...
<script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
			<body>
				<section class="contact-clean">
					<form method="post" action="">
						<h2 class="text-center">Ferramenta de Criptografia - Cyber Root</h2>
			<div class="form-group">
				<input class="form-control is-invalid" type="text" name="string" placeholder="Insira seu Texto ">
			</div>
			<div class="form-group">
				Criptografar<input type="radio"  class="form-control" name="cod" value="encriptar"><br>
				Descriptografar<input type="radio"  class="form-control" name="cod" value="decriptar">
			</div>
			<div class="form-group">
	...
	<center>
<?php
if (!empty($_POST['string']) and !empty($_POST['cod'])){
$stringa=addslashes($_POST['string']);
$cod=addslashes($_POST['cod']);
	if ($cod=="encriptar"){
		$message=criptar($stringa);
		echo "<h3>A String Encriptada é: ".$message."</h3>";
	} else 
	if ($cod=="decriptar"){
		$message=decriptar($stringa);
		echo "<h3>A String Decriptada é: ".$message."</h3>";
	}
}else{

}

function criptar($string){

$n=array("!","@","#","$","&","*","(",")","_","-","+","[","]",",",".","1","8","6","7","2","0","3","9","/","5","4");
